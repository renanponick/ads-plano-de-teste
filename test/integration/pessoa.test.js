...
describe('Testes do primeiro exercício', () => {
   ...
   it('" CT03 - No Postman preencher campo email, com um email válido: email: joana@gmail.com - O sistema deverá salvar o email no banco de dados."', async () => {
   ...
   it('" CT04- No Postman preencher campo senha, com um senha válido: senha: C@ch0rr0$80nito$ - O sistema deverá salvar o senha no banco de dados."', async () => {
